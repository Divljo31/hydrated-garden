...
**TL;DR:** HDX is the native governance and incentive token of [[wiki/hydration\|hydration]], enabling on-chain voting via [[wiki/opengov\|opengov]] and staking for protocol revenue via [[wiki/bonding-curve\|bonding-curve]] mechanics.
...
HDX can be staked to earn protocol revenue. Revenue sources include LP fees from Hydration's own HDX position in the [[omnipool\|omnipool]] and treasury subsidies. Staking uses a [[wiki/bonding-curve\|bonding-curve]] model:
